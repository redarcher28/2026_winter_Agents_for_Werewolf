...
class DataStorageService(DataStorageInterface):
    ...
    # route 10-1: 获取所有游戏功能主入口（从测试函数调用）
    ...
    # route 11-1: 删除游戏数据功能主入口（从测试函数调用）
